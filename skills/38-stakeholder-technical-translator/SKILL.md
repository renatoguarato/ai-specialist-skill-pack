---
name: stakeholder-technical-translator
description: Traduz assuntos técnicos complexos para linguagem adequada a negócio, produto, liderança ou engenharia.
---

# Stakeholder Technical Translator

## Objetivo
Adaptar a mesma decisão para públicos diferentes.
...
Evite jargão quando o público não for técnico.
