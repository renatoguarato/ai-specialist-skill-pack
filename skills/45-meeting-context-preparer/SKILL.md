...
description: Prepara contexto técnico para reuniões, reunindo fatos, decisões pendentes, riscos e perguntas.
---

# Meeting Context Preparer

## Objetivo
Chegar à reunião sabendo o que já pode ser respondido sem perguntar.
